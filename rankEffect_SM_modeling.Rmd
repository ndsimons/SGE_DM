...
## Permutations for empirical null ##
################################################################################################################################
...
res_fullDF <- na.omit(res_fullDF)
shuffled_elos_pvals_NC_noNAN <- na.omit(shuffled_elos_pvals_NC)

res_fullDF <- perm.fdr(res_fullDF,shuffled_elos_pvals_NC_noNAN,"p_value_trtNC.elo_centered","eloNC")
...
```{r troubleshoot perm fdr}

input_df <- res_fullDF
perm_df <- shuffled_elos_pvals_NC
Pvals_col_name <- "p_value_trtNC.elo_centered"
name <- "eloNC"
