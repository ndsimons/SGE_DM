...
```{r is there correlation between the betas}
...
for (cluster in c("00","14","02","05","06","07")) {
  ...
  p1 <- ggplot() +
    geom_point(aes(x = LPS1, y = NC1), alpha = .1) +
  ...
  p2 <- ggplot() +
    geom_point(aes(x = LPS2, y = NC2), alpha = .1) +
  ...
  p3 <- ggplot() +
    geom_point(aes(x = LPS3, y = NC3), alpha = .1) +
    geom_smooth(aes(x = LPS3, y = NC3), method = "lm") +
    ggtitle(paste0("c",cluster," - groom"))
  ...
  p4 <- ggplot() +
    geom_point(aes(x = LPS4, y = NC4), alpha = .1) +
    geom_smooth(aes(x = LPS4, y = NC4), method = "lm") +
    ggtitle(paste0("c",cluster," - elo"))
