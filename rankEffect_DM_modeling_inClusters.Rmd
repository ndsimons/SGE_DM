...
for (cluster in c("00","01","02","03","04","05","06","07","08","09","10")) {
  #cluster <- "01"
...
plot_grid(p1,p2,p3, ncol = 3)
ggsave(paste0(figDir,"DMpb_v_DM_ge__by_individual_noLim_c",cluster,".png"))
...
plot_grid(p1,p2,p3, ncol = 3)
ggsave(paste0(figDir,"var_v_DM_ge__by_individual_noLim_c",cluster,".png"))
...
plot_grid(p1,p2,p3, ncol = 3)
ggsave(paste0(figDir,"var_v_DM_ge__by_individual_xLim250_c",cluster,".png"))
...
random_effects=resid_DM[,1:length(indIDs)]
...
plotModelHists(get(paste0("res_full_DMpb_c",cluster)), folderName = figDir, modelName = paste0("DMpb_model_c",cluster))
...
plotModelHists(get(paste0("res_fullDF_var_c",cluster)), folderName = figDir, modelName = paste0("Var_model_c",cluster))
...
plot_grid(p1,p2,p3, ncol = 3)
ggsave(paste0(figDir,"varResidmean_v_mean_ge__by_individual_c",cluster,".png"))
...
plot_grid(p1,p2,p3, ncol = 3)
ggsave(paste0(figDir,"varResidmean_v_mean_ge__by_individual_yLim500_c",cluster,".png"))
...
ggsave(paste0(figDir,"stdBeta_comp_LPSelo_DM_v_Var_c",cluster,".png"))
...
ggsave(paste0(figDir,"stdBeta_comp_Trt_DM_v_Var_c",cluster,".png"))
...
ggsave(paste0(figDir,"stdBeta_hist_Trt_DM_and_Var__c",cluster,".png"))
...
ggsave(paste0(figDir,"stdBeta_hist_Trt_DM_and_Var__sigOnly_c",cluster,".png"))
...
######-need to make an elo model but use pbMean instead of DM
######Fit an elo model for each gene using emmreml
...
#Declare object res_full to store in it the model results: beta coefficients, standard deviations and p values
res_full=resid_pbMean[,1:(3*ncol(design))]
colnames(res_full)[1:ncol(design)]=paste0("beta_",colnames(design))
colnames(res_full)[(ncol(design)+1):(2*ncol(design))]=paste0("sdev_",colnames(design))
colnames(res_full)[((2*ncol(design))+1):(3*ncol(design))]=paste0("p_value_",colnames(design))

#Declare object random_effects to store in it the individual-wise u random effects
random_effects=resid_pbMean[,1:length(indIDs)]
colnames(random_effects)=metadata[1:length(indIDs),'ID']
...
for(i in 1:nrow(resid_pbMean))
{
  emma=emmreml(y=resid_pbMean[i,],X=design,Z=as.matrix(Z),K=as.matrix(K),varbetahat=T,varuhat=T,PEVuhat=T,test=T)
  random_effects[i,]=t(emma$uhat)
  res_full[i,]=t(c(emma$betahat,emma$varbetahat,emma$pvalbeta[,"none"]))
}

assign(value = data.frame(res_full), x = paste0("res_fullDF_pbMean_c",cluster))

plotModelHists(get(paste0("res_fullDF_pbMean_c",cluster)), folderName = figDir, modelName = paste0("pbMean_model_c",cluster))
...
#                 y = .95 * max(res_fullDF$beta_trtNC / (res_fullDF$sdev_trtNC)^0.5)),
#                 label = paste0("R = ",round(trtR, digits = 3)))
# ggsave(paste0(figDir,"stdBeta_comp_Trt_DM_v_Var_pbMeanSigColor_c",cluster,".png"))
# 
# ggplot() +
#   geom_point(aes(x = res_fullvarDF$beta_trtLPS.elo_centered / (res_fullvarDF$sdev_trtLPS.elo_centered)^0.5,
#                  y = res_fullDF$beta_trtLPS.elo_centered / (res_fullDF$sdev_trtLPS.elo_centered)^0.5,
...
#                 y = .95 * max(res_fullDF$beta_trtLPS.elo_centered / (res_fullDF$sdev_trtLPS.elo_centered)^0.5)),
#                 label = paste0("R = ",round(lpsEloR, digits = 3)))
# ggsave(paste0(figDir,"stdBeta_comp_LPSelo_DM_v_Var_pbMeanSigColor_c",cluster,".png"))
# 
...
#                 label = paste0("R = ",round(trtR, digits = 3))) +
#   labs(col = "pbMeans\nSig and\nLPS dir")
# ggsave(paste0(figDir,"stdBeta_comp_Trt_DM_v_Var_pbMeanUpDownColor_c",cluster,".png"))
# 
# ggplot() +
#   geom_point(aes(x = res_fullvarDF$beta_trtLPS.elo_centered / (res_fullvarDF$sdev_trtLPS.elo_centered)^0.5,
#                  y = res_fullDF$beta_trtLPS.elo_centered / (res_fullDF$sdev_trtLPS.elo_centered)^0.5,
...
#                 label = paste0("R = ",round(lpsEloR, digits = 3))) +
#   labs(col = "pbMeans\nSig and\nLPS dir")
# ggsave(paste0(figDir,"stdBeta_comp_LPSelo_DM_v_Var_pbMeanUpDownColor_c",cluster,".png"))
# 
# 
# 
...
#   ylab("DM model - std betas LPS") +
#   labs(col = "pbMeans\nSig and\nLPS dir")
# ggsave(paste0(figDir,"stdBeta_comp_Trt_DM_v_Var_pbMeanUpDownColor_sigDM_c",cluster,".png"))
# 
# 
...
#   ylab("DM model - std betas LPS") +
#   labs(col = "pbMeans\nSig and\nLPS dir")
# ggsave(paste0(figDir,"stdBeta_comp_Trt_DM_v_Var_pbMeanUpDownColor_sigVar_c",cluster,".png"))
# 
# 
# 
...
# 
# ggsave(paste0(figDir,"stdBeta_comp_Trt-var_v_Trt-pbMean_c",cluster,".png"))
# 
...
# ggsave(paste0(figDir,"stdBeta_comp_Trt-DM_v_Trt-pbMean_c",cluster,".png"))
...
ggsave(paste0(figDir,"hist_mean_dm_and_var_Rvalues_c",cluster,"_spearman.png"))
...
ggplot() +
  ...
  xlab('R') +
  scale_fill_discrete(name = "")
ggsave(paste0(figDir,"hist_pbMean_dm_and_var_Rvalues_c",cluster,"_spearman.png"))
...
ggplot() +
  ...
  xlab('R') +
  scale_fill_discrete(name = "")
ggsave(paste0(figDir,"hist_means_and_var_Rvalues_c",cluster,"_spearman.png"))
...
ggplot() +
  ...
  xlab('R') +
  scale_fill_discrete(name = "")
ggsave(paste0(figDir,"hist_means_and_dm_Rvalues_c",cluster,"_spearman.png"))
...
clusterCellID <- as.data.frame(c("00","01","02","03","04","05","06","07"))
...
for (c in 1:dim(clusterCellID)[1]) {
  ...
  DMemmreml <- get(paste0("res_fullDFc",cluster))
  ...
  dmData <- DMemmreml[,c(2,8,14)]
  dmData$stdbeta_trtNC <- dmData$beta_trtNC / sqrt(dmData$sdev_trtNC)
  colnames(dmData) <- paste0(colnames(dmData),"_dm")
  dmData$gene <- rownames(dmData)
  ...
  c01betas <- merge(c01betas, dmpbData, by = "gene")
  ...
  ggsave(paste0(figDir,"StdBetas_DMpb_v_DM_c",cluster,".png"), width = 6, height = 4)
  ...
  ggplot(data = c01betas, aes(x = stdbeta_trtLPS_exp, y = stdbeta_trtNC_dmpb)) +
    ...
    ylab("Standardized Treatment Betas - DMpb model") +
    ggtitle(paste0("cluster ",cluster))
  ggsave(paste0(figDir,"StdBetas_DMpb_v_PaulBetas_c",cluster,".png"), width = 6, height = 4)
  ...
  ggsave(paste0(figDir,"StdBetas_DMpb_v_PaulBetas_noisyGenes_c",cluster,".png"), width = 6, height = 4)
  ...
  for (geneName in rownames(head(noisyLPSgenes[order(noisyLPSgenes$stdbeta_trtNC_dmpb),], n = 5))) {
    ...
    ggsave(paste0(figDir,"noisyGenes_raw_pbMean_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)
    
    ggplot(data = DMpbRaw, aes(x = variable, y = value, group = ID, col = ID)) +
      geom_path() + theme(legend.position = "none") +
      xlab("treatment") + ylab("DM from pseudobulk") +
      ggtitle(paste0("cluster ",cluster,", cell type ",cellID,", gene ",geneName))
    ggsave(paste0(figDir,"noisyGenes_raw_DMpb_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)
    ...
    ggsave(paste0(figDir,"noisyGenes_raw_DMpb_v_pbMean_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)
  }
  ...
  highLPSgenes <- subset(c01betas, stdbeta_trtLPS_exp > pbMeanCutoff & abs(stdbeta_trtNC_dm) < .5)
  ...
  ggsave(paste0(figDir,"StdBetas_DMpb_v_PaulBetas_highLPSGenes_c",cluster,".png"), width = 6, height = 4)
  ...
  ggplot() +
    ...
    ggtitle(paste0("cluster ",cluster," ",cellID," cells"),
            subtitle = paste0(nHigh," highlighted genes"))
  ggsave(paste0(figDir,"StdBetas_DMpb_v_PaulBetas_highLPSGenes_random_c",cluster,".png"), width = 6, height = 4)
  ...
  for (geneName in randomGeneNames) {
    ...
    ggplot(data = PBmeanRaw, aes(x = variable, y = value, group = ID, col = ID)) +
      ...
      xlab("treatment") + ylab("pseudobulk mean") +
      ggtitle(paste0("cluster ",cluster,", cell type ",cellID,", gene ",geneName))
    ggsave(paste0(figDir,"highLPSGenes_raw_pbMean_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)
    
    ggplot(data = DMpbRaw, aes(x = variable, y = value, group = ID, col = ID)) +
      geom_path() + theme(legend.position = "none") +
      xlab("treatment") + ylab("DM from pseudobulk") +
      ggtitle(paste0("cluster ",cluster,", cell type ",cellID,", gene ",geneName))
    ggsave(paste0(figDir,"highLPSGenes_raw_DMpb_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)

    ggplot(data = VarRaw, aes(x = variable, y = value, group = ID, col = ID)) +
      geom_path() + theme(legend.position = "none") +
      xlab("treatment") + ylab("raw Variance") +
      ggtitle(paste0("cluster ",cluster,", cell type ",cellID,", gene ",geneName))
    ggsave(paste0(figDir,"highLPSGenes_raw_Var_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)
    ...
    ggplot() +
      ...
      ggtitle(paste0("cluster ",cluster,", cell type ",cellID,", gene ",geneName),
              subtitle = "red = LPS, grey = NC")
    ggsave(paste0(figDir,"highLPSGenes_raw_DMpb_v_pbMean_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)
    ...
    ggplot() +
      ...
      ggtitle(paste0("cluster ",cluster,", cell type ",cellID,", gene ",geneName),
              subtitle = "red = LPS, grey = NC")
    ggsave(paste0(figDir,"highLPSGenes_raw_Var_v_pbMean_c",cluster,"_gene_",geneName,".png"), width = 6, height = 4)
...
colnames(trtFDR) <- colnames(elotrtFDR) <- "cluster"

trtFDR$fdr20 <- trtFDR$fdr10 <- trtFDR$fdr05 <- trtFDR$fdr01 <- 0
elotrtFDR$fdr20 <- elotrtFDR$fdr10 <- elotrtFDR$fdr05 <- elotrtFDR$fdr01 <- 0
...
trtFDR$nGenes <- elotrtFDR$nGenes <- c(6251,7359,2907,749,2541,5416,1214,1266,390,1350,2074)[1:8]

dmMetaData$nInds <- c(45,45,45,31,45,45,41,43,44,26,20)[1:8]
