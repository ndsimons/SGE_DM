...
gtBehav <- pValplotTable %>%
  ...
  gt()%>%
  tab_header(
    title = "Binomial Test Results - Agonisms Received",
  ...
  cols_label(
    ...
    betaDownCount = "- Beta",
    #pvalweightBetas = "Pvalue",
    betaUpCount = "+ Beta"
  ) %>% 
 data_color(
   columns = pvalweightBetas,
...
gtsave(gtBehav, paste0(figDir,"/7_table_sigBetas_allCells_agRec.png"))
...
gtsave(gtBehav, paste0(figDir,"/7_table_sigBetas_allCells_groom.png"))
