...
if ( "dmResidDataFrame.txt" %in% plotFilesList ) {
  ...
  write.table(x = rawDataDF, file = paste0(plotDataDir,"dmResidDataFrame.txt"))
}
...
varMean
ggsave(paste0(figDir,"2_resid_var_v_pbMean_ge__by_individual_c",cluster,".png"))
...
dmMean
ggsave(paste0(figDir,"2_resid_DMpb_v_pbMean_ge__by_individual_c",cluster,".png"))


plot_grid(varMean,dmMean, ncol = 2)
ggsave(paste0(figDir,"2_resid_DMpb_and_var_v_pbMean_ge__by_individual_c",cluster,".png"))
...
varMean
ggsave(paste0(figDir,"2_resid_var_v_pbMean_ge__by_individual_c",cluster,"_xlim4.png"))

dmMean <- dmMean

dmMean
ggsave(paste0(figDir,"2_resid_DMpb_v_pbMean_ge__by_individual_c",cluster,"_xlim4.png"))


plot_grid(varMean,dmMean, ncol = 2)
ggsave(paste0(figDir,"2_resid_DMpb_and_var_v_pbMean_ge__by_individual_c",cluster,"_xlim4.png"))
...
ggsave(paste0(figDir,"3_DMpb_and_var_correlation_with_mean_c",cluster,".png"))
...
ggsave(paste0(figDir,"4_resid_DMpb_and_var_v_pbMean_ge__by_individual_c",cluster,".png"))
...
for (b in c("agRec","groom")) {
  ...
  ggsave(paste0(figDir,"5_fdr_sig_genes_by_cellType_",b,".png"))
...
ggplot(betaHistAgRec, aes(x = betaVal, y = cellClust, group = cellClust, color = cellClust, fill = cellClust)) +
...
ggsave(paste0(figDir,"/sigBetas_allCells_agRec_density.png"))

ggplot(betaHistAgRec, aes(x = betaVal, y = cellClust, group = cellClust, color = cellClust, fill = cellClust)) +
  geom_density_ridges() + scale_fill_viridis(discrete=TRUE) + theme_minimal() + scale_color_viridis(discrete=TRUE) +
  ggtitle("Agonisms Received")

ggsave(paste0(figDir,"/sigBetas_allCells_agRec_hist.png"))


betaHistGroom <- subset(betaHistDF, behaveVar == "groom")

ggplot(betaHistGroom, aes(x = betaVal, y = cellClust, group = cellClust, color = cellClust, fill = cellClust)) +
  geom_density_ridges(stat = "binline") + scale_fill_viridis(discrete=TRUE) + theme_minimal() + scale_color_viridis(discrete=TRUE) +
  ggtitle("Overall Grooming")

ggsave(paste0(figDir,"/sigBetas_allCells_groom_density.png"))

ggplot(betaHistGroom, aes(x = betaVal, y = cellClust, group = cellClust, color = cellClust, fill = cellClust)) +
  geom_density_ridges() + scale_fill_viridis(discrete=TRUE) + theme_minimal() + scale_color_viridis(discrete=TRUE) +
  ggtitle("Overall Grooming")

ggsave(paste0(figDir,"/sigBetas_allCells_groom_hist.png"))
